...
Class Transferencia_model extends CI_Model{
	...
	function compras_anio_actual($datos){
		...
		WHERE
			...
			clientes_productos.id_cliente = {$datos['identificacion']}
		GROUP BY
	...
	function compras_anio_seleccionado($datos){
		//Id de oficina cuando se seleccionan todas
		$oficina = "";
	...
	function compras_ultimos_meses($datos){
		//Id de oficina cuando se seleccionan todas
		$oficina = "";
	...
	function transferencias_mensuales($datos){
		//Id de oficina cuando se seleccionan todas
		$oficina = "";
	...
	function total_transferencias($identificacion){
		$sql =
		"SELECT
		...
		clientes_productos
		WHERE
		clientes_productos.id_cliente = {$identificacion}";
