...
<!-- Sólo dos usuarios pueden crear datos a listas -->
<?php if ($this->session->userdata('id_usuario') == "1" || $this->session->userdata('id_usuario') == "2") { ?>
    <!-- Botón agregar dato -->
...
<div class="table-responsive">
	...
	<table id="tabla_listas" class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <!-- Sólo los dos primeros usuarios pueden modificar -->
                    <?php if ($this->session->userdata('id_usuario') == "1" || $this->session->userdata('id_usuario') == "2") { ?>
