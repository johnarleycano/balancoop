...
$departamentos = $this->listas_model->cargar_departamentos($codigo_pais);
?>
        ...
        <tbody>
            ...
            <tr>
				<td class="alinear_derecha">
                    ...
                    <?php if ($this->session->userdata('tipo') == "3") { ?>
                        <span onclick="javascript:editar_dato(<?php echo $cont; ?>)" class="glyphicon glyphicon-edit"></span>
                    <?php } ?>
                </td>
        ...
        <div class="modal-dialog">
			<div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 id="titulo_mensaje" class="modal-title">Agregar nuevo departamento</h4>
