...
// $filtros = $this->filtro_model->cargar_filtros();
?>
...
<div class="table-responsive">
	...
	<table id="tabla_filtros" class="table">
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td onclick="javascript:actualizar_filtro(<?php echo $filtro->intCodigo; ?>)"><span class="glyphicon glyphicon-edit"></span></td>
...
// Cuando den clic sobre editar     
    ...
    function actualizar_filtro(elemento){     
        //Cargamos la tabla
        $("#cont_filtros").load("listas/cargar_interfaz", {tipo: 'tabla_filtros'});
