...
<?php if ($id_asociado) { ?>
    <script type="text/javascript">
        $(document).ready(function(){ 
            ...
            $('#dia_nacimiento_conyugue > option[value="<?php echo date("d", strtotime($asociado->FechaNacimiento_Conyugue)); ?>"]').attr('selected', 'selected');
            $('#mes_nacimiento_conyugue > option[value="<?php echo date("m", strtotime($asociado->FechaNacimiento_Conyugue)); ?>"]').attr('selected', 'selected');
            $('#anio_nacimiento_conyugue > option[value="<?php echo date("Y", strtotime($asociado->FechaNacimiento_Conyugue)); ?>"]').attr('selected', 'selected');
