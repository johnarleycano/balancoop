...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $('#dia_nacimiento_hijo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("d", strtotime($datos["fecha_nacimiento"])); ?>"]').attr('selected', 'selected');
        $('#mes_nacimiento_hijo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("m", strtotime($datos["fecha_nacimiento"])); ?>"]').attr('selected', 'selected');
        $('#anio_nacimiento_hijo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("Y", strtotime($datos["fecha_nacimiento"])); ?>"]').attr('selected', 'selected');
	});//Document.ready1
</script>