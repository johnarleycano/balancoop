...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //Fecha inicio
        $('#dia_inicio_cargo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("d", strtotime($datos["fecha_inicio"])); ?>"]').attr('selected', 'selected');
        $('#mes_inicio_cargo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("m", strtotime($datos["fecha_inicio"])); ?>"]').attr('selected', 'selected');
        $('#anio_inicio_cargo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("Y", strtotime($datos["fecha_inicio"])); ?>"]').attr('selected', 'selected');

        //Fecha final
        $('#dia_fin_cargo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("d", strtotime($datos["fecha_final"])); ?>"]').attr('selected', 'selected');
        $('#mes_fin_cargo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("m", strtotime($datos["fecha_final"])); ?>"]').attr('selected', 'selected');
        $('#anio_fin_cargo' + '<?php echo $numero; ?>' + ' > option[value="<?php echo date("Y", strtotime($datos["fecha_final"])); ?>"]').attr('selected', 'selected');
    });//Document.ready
</script>