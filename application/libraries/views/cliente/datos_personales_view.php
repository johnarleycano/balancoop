...
<div class="panel panel-primary">           
    ...
    <div class="panel-body" id="datos_personales">
        <div class="oculto">
            ...
            <!-- Si el estado de consejero o el estado de junta es activo, muestra estado directivo -->
            <div id="cont_junta_consejero">
                <div class="form-group">
                    <!-- Estado Directivo -->
                    <label for="input_estado_directivo" class="col-sm-5 control-label">Estado como Directivo</label>
                    <div class="col-sm-7">
...
<?php if ($id_asociado) { ?>
    <script type="text/javascript">
        $(document).ready(function(){ 
            ...
            $('#dia_nacimiento_cliente > option[value="<?php echo date("d", strtotime($asociado->FechaNacimiento)); ?>"]').attr('selected', 'selected');
            $('#mes_nacimiento_cliente > option[value="<?php echo date("m", strtotime($asociado->FechaNacimiento)); ?>"]').attr('selected', 'selected');
            $('#anio_nacimiento_cliente > option[value="<?php echo date("Y", strtotime($asociado->FechaNacimiento)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_ingreso_cliente > option[value="<?php echo date("d", strtotime($asociado->FechadeIngresoalaCooperativa)); ?>"]').attr('selected', 'selected');
            $('#mes_ingreso_cliente > option[value="<?php echo date("m", strtotime($asociado->FechadeIngresoalaCooperativa)); ?>"]').attr('selected', 'selected');
            $('#anio_ingreso_cliente > option[value="<?php echo date("Y", strtotime($asociado->FechadeIngresoalaCooperativa)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_retiro_cliente > option[value="<?php echo date("d", strtotime($asociado->FechadeRetiro)); ?>"]').attr('selected', 'selected');
            $('#mes_retiro_cliente > option[value="<?php echo date("m", strtotime($asociado->FechadeRetiro)); ?>"]').attr('selected', 'selected');
            $('#anio_retiro_cliente > option[value="<?php echo date("Y", strtotime($asociado->FechadeRetiro)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_inicio_cliente > option[value="<?php echo date("d", strtotime($asociado->Fecha_Inicio_Empleado)); ?>"]').attr('selected', 'selected');
            $('#mes_inicio_cliente > option[value="<?php echo date("m", strtotime($asociado->Fecha_Inicio_Empleado)); ?>"]').attr('selected', 'selected');
            $('#anio_inicio_cliente > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Inicio_Empleado)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_inicio_delegado > option[value="<?php echo date("d", strtotime($asociado->Fecha_Inicio_Delegado)); ?>"]').attr('selected', 'selected');
            $('#mes_inicio_delegado > option[value="<?php echo date("m", strtotime($asociado->Fecha_Inicio_Delegado)); ?>"]').attr('selected', 'selected');
            $('#anio_inicio_delegado > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Inicio_Delegado)); ?>"]').attr('selected', 'selected');
            $('#dia_fin_delegado > option[value="<?php echo date("d", strtotime($asociado->Fecha_Fin_Delegado)); ?>"]').attr('selected', 'selected');
            $('#mes_fin_delegado > option[value="<?php echo date("m", strtotime($asociado->Fecha_Fin_Delegado)); ?>"]').attr('selected', 'selected');
            $('#anio_fin_delegado > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Fin_Delegado)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_inicio_consejero > option[value="<?php echo date("d", strtotime($asociado->Fecha_Inicio_Consejero)); ?>"]').attr('selected', 'selected');
            $('#mes_inicio_consejero > option[value="<?php echo date("m", strtotime($asociado->Fecha_Inicio_Consejero)); ?>"]').attr('selected', 'selected');
            $('#anio_inicio_consejero > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Inicio_Consejero)); ?>"]').attr('selected', 'selected');
            $('#dia_fin_consejero > option[value="<?php echo date("d", strtotime($asociado->Fecha_Fin_Consejero)); ?>"]').attr('selected', 'selected');
            $('#mes_fin_consejero > option[value="<?php echo date("m", strtotime($asociado->Fecha_Fin_Consejero)); ?>"]').attr('selected', 'selected');
            $('#anio_fin_consejero > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Fin_Consejero)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_inicio_junta > option[value="<?php echo date("d", strtotime($asociado->Fecha_Inicio_Junta)); ?>"]').attr('selected', 'selected');
            $('#mes_inicio_junta > option[value="<?php echo date("m", strtotime($asociado->Fecha_Inicio_Junta)); ?>"]').attr('selected', 'selected');
            $('#anio_inicio_junta > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Inicio_Junta)); ?>"]').attr('selected', 'selected');
            $('#dia_fin_junta > option[value="<?php echo date("d", strtotime($asociado->Fecha_Fin_Junta)); ?>"]').attr('selected', 'selected');
            $('#mes_fin_junta > option[value="<?php echo date("m", strtotime($asociado->Fecha_Fin_Junta)); ?>"]').attr('selected', 'selected');
            $('#anio_fin_junta > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Fin_Junta)); ?>"]').attr('selected', 'selected');
            ...
            $('#dia_inicio_comites > option[value="<?php echo date("d", strtotime($asociado->Fecha_Inicio_Comites)); ?>"]').attr('selected', 'selected');
            $('#mes_inicio_comites > option[value="<?php echo date("m", strtotime($asociado->Fecha_Inicio_Comites)); ?>"]').attr('selected', 'selected');
            $('#anio_inicio_comites > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Inicio_Comites)); ?>"]').attr('selected', 'selected');
            $('#dia_fin_comites > option[value="<?php echo date("d", strtotime($asociado->Fecha_Fin_Comites)); ?>"]').attr('selected', 'selected');
            $('#mes_fin_comites > option[value="<?php echo date("m", strtotime($asociado->Fecha_Fin_Comites)); ?>"]').attr('selected', 'selected');
            $('#anio_fin_comites > option[value="<?php echo date("Y", strtotime($asociado->Fecha_Fin_Comites)); ?>"]').attr('selected', 'selected');
