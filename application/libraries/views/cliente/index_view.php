...
<form id="form_cliente" class="form-horizontal" role="form">
	<!-- Columna 1 -->
    <div id="cont_datos_personales" class="col-lg-6">
    ...
    <div class="col-lg-6">
        ...
        <!-- Panel Productos del cliente -->
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-tag"></span> Productos</h3>
            </div>
            <div class="panel-body">
                <!-- Contenedor para agregar los produtos -->
                <div id="productos"></div>

                <!-- Botón agregar producto -->
                <button id="btn_agregar_producto" type="button" class="btn btn-info btn-block btn-xs">Agregar producto</button>
            </div>
        </div><!-- Panel Productos del cliente -->

        <!-- Panel Campos personalizados -->
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-wrench"></span> Campos personalizados</h3>
            </div>
            <div class="panel-body">
        ...
        </div><!-- Panel Campos personalizados -->
    </div><!-- Columna 2 -->
...
<script type="text/javascript">
    $(document).ready(function(){ 
        ...
        //Si es un asociado existente
        if (id_asociado) {
            // Verificaremos si existen productos creados
            //productos_existentes = ajax("<?php echo site_url('cliente/cargar') ?>", {"tipo": "producto", "id_asociado": id_asociado}, 'JSON');

        //     //Recorreremos los productos para crearlos en pantalla
        //     $.each(beneficiarios_existentes, function(key, val){
        //         datos = {
        //             "nombre": val.strNombre,
        //             "telefono_casa": val.TelefonoCasa,
        ...
        //         //Cargamos la vista en el div
        //         $("#producto" + total_productos).load("<?php echo site_url('cliente/agregar_beneficiarios'); ?>", {numero: total_productos, datos: datos});
        ...
        $("#form_cliente").on("submit", function(){ 
            ...
            datos_formulario = {
                ...
                'FechadeIngresoalaCooperativa': anio_ingreso_cliente.val() + "-" + mes_ingreso_cliente.val() + "-" + dia_ingreso_cliente.val(),
                'FechadeRetiro': anio_retiro_cliente.val() + "-" + mes_retiro_cliente.val() + "-" + dia_retiro_cliente.val(),
                ...
                'FechaNacimiento': anio_nacimiento_cliente.val() + "-" + mes_nacimiento_cliente.val() + "-" + dia_nacimiento_cliente.val(),
                'FechaNacimiento_Conyugue': anio_nacimiento_conyugue.val() + "-" + mes_nacimiento_conyugue.val() + "-" + dia_nacimiento_conyugue.val(),
                'Habil': habil.val(),
