...
<div class="navbar-collapse collapse">
    <ul class="nav navbar-nav">
        ...
        <?php if($this->session->userdata('id_usuario')){ ?>
            ...
            <li><a href="<?php echo site_url('transferencia/index/'.$this->session->userdata('id_empresa').'/0/'.$this->session->userdata('identificacion').'/get/'); ?>">Transferencia Solidaria</a></li>
